...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/unsubscribe/sms/remove",
    }
...
def sync_detailed(
    *,
    ...
    """Opt identifiers back in (sms)

     Writes a batch of SMS opt-out / opt-in records, opting each identifier back in to the targeted
