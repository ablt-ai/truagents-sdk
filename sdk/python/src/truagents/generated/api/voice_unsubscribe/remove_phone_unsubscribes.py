...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/unsubscribe/phone/remove",
    }
...
def sync_detailed(
    *,
    ...
    """Opt identifiers back in (phone)

     Writes a batch of voice opt-out / opt-in records, opting each identifier back in to the targeted
