...
class PhoneUnsubscribeBatchRequest:
    """
    Example:
        {'org_slug': 'acme-corp', 'items': [{'phone': '+15551234567'}]}

    Attributes:
        items (list[PhoneUnsubscribeItem]): Up to 10,000 items per request; an empty array is accepted and writes
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.phone_unsubscribe_item import (
            PhoneUnsubscribeItem,  # noqa: PLC0415
        )
